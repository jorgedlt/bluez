#!/usr/bin/env bash
# Login to IMS 3127011 (SandboxAccnt) using $HOME/ibmcloud_api_key_sandbox.json

set -euo pipefail

REGION="${1:-us-south}"         # allow override: ./ibm-login-011.sh eu-de
KEYFILE="${HOME}/ibmcloud_api_key_sandbox.json"
